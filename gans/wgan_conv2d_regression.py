...
#     def wass_reg_loss(self, wasserstain, regression, alpha=0.5):
#         return wasserstein + alpha * regression
    ...
    def build_critic(self):
        ...
        # output image validity and energy regression
        validity = model(img)
        energy = model(img)

        return Model(input=img, output=[validity, energy])
...
#                     imgs_val = X_val[idx_val]
                ...
                gen_imgs = self.generator.predict(generator_input)
...
if __name__ == '__main__':
    ...
    wgan = WGAN()
    wgan.train(steps=4000, batch_size=128, sample_interval=25)
